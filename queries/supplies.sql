-- supplies.sql
--
-- Per-event supply (collateral deposit) records on Aave V3 + Compound V3.
--
-- Parameters:
...
--   amount_usd     double
--
-- NOTE: TODO_VERIFY table choices. The unioned Spellbook tables below are
-- placeholders.
